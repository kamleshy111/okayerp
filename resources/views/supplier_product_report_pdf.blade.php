...
<head>
  <meta charset="UTF-8">
  <title>Supplier Product Purchase Report</title>
  <style>
    body {
      margin: 0;
...
<div class="invoice-container">
  ...
  <!-- Meta Table (Supplier Info & Period Details) -->
  <table class="border-bottom meta-table">
    <tr>
      <td class="border-right">
        <table class="meta-sub-table">
          <tr>
            <td style="width: 35%; color: #6b7280;">Supplier Name</td>
      ...
      <td>
        <table class="meta-sub-table">
          <tr>
            ...
            <td class="bold">Product-wise Purchase Summary</td>
          </tr>
          <tr>
    ...
    <tbody>
      ...
      <tr>
        <td colspan="5" class="text-center" style="padding: 20px; color: #9ca3af;">
          No product purchases found matching the criteria.
        </td>
      </tr>
      @endforelse
    ...
    <tr>
      <td class="border-right" style="vertical-align: top;">
        ...
        <ul class="terms-list" style="font-size: 9px; color: #4b5563;">
          <li>This is a system-generated product purchase statement.</li>
          <li>All product quantities reflect recorded purchase bills and purchase returns.</li>
          <li>For questions regarding this report, please contact accounts support.</li>
        </ul>
      </td>
