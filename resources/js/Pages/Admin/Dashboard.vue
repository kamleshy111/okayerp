...
const totalStores = computed(() => page.props.totalStores ?? 0)
...
const totalSaleProducts = computed(() => page.props.totalSaleProducts ?? 0)

const percentageChangeStore = computed(() => page.props.percentageChangeStore ?? 0)
        ...
        <section class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                ...
                <div
                    ...
                    <p class="font-semibold text-gray-400 mb-2 uppercase">Store Overview</p>
                    <div class="flex items-center justify-between mb-4">
                        <div class="bg-blue-100 p-2 rounded-full">
                            <span class="text-blue-500 text-xl p-0">📦</span>
                        </div>
                        <div class="text-right">
                            <p class="text-gray-500 text-sm">Total Store</p>
                            <p class="text-lg font-bold text-gray-800">{{ totalStores }}</p>
                        </div>
                    </div>
                    <div class="text-sm text-green-500 mb-2">
                        <span
                            :class="{
                                'text-green-500': percentageChangeStore > 0,
                                'text-red-500': percentageChangeStore < 0,
                                'text-gray-500': percentageChangeStore === 0
                            }"
                        >
                            {{ percentageChangeStore > 0 ? '▲' : percentageChangeStore < 0 ? '▼' : '–' }}
                            {{ percentageChangeStore }}%
                        </span>
                ...
                <div
                    class="bg-white shadow rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow duration-300">
                    <p class="font-semibold text-gray-400 mb-2 uppercase">Customer Overview</p>
                    <div class="flex items-center justify-between mb-4">
                        <div class="bg-blue-100 p-2 rounded-full">
                            <span class="text-blue-500 text-xl p-0">👥</span>
                        </div>
                ...
                <div
                    class="bg-white shadow rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow duration-300">
                    <p class="font-semibold text-gray-400 mb-2 uppercase">Supplier Overview</p>
                    <div class="flex items-center justify-between mb-4">
                        <div class="bg-blue-100 p-2 rounded-full">
                            <span class="text-blue-500 text-xl p-0">👥</span>
                        </div>
