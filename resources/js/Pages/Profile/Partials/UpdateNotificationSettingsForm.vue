...
const form = useForm({
    ...
    whatsapp_api_url: user.whatsapp_api_url || '',
    whatsapp_api_key: user.whatsapp_api_key || '',
    whatsapp_app_name: user.whatsapp_app_name || '',
    ...
    sms_api_url: user.sms_api_url || '',
    sms_api_key: user.sms_api_key || '',
    sms_sender_name: user.sms_sender_name || '',
