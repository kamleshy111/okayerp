...
<template>
    <Head title="Supplier Payment History">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p class="text-xs text-gray-400 mt-1">Total combined balance of purchases, payments and returns</p>
                </div>
              </div>
              ...
              <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 flex flex-col justify-between">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div>
                    <span class="text-xs text-gray-400 block font-medium uppercase">Total Paid</span>
                    <span class="text-lg font-bold text-emerald-600">+ ₹{{ totalPaid.toFixed(2) }}</span>
                  </div>
                  <div>
