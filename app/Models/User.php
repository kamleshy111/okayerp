...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'invoice_print_size',
        'hide_bank_details',
        'allow_provide_additional_descriptions',
        'allow_gst_invoice',
        'allow_alternate_units',
        'allow_customer_based_pricing',
        'city',
        'district',
        'state',
        'country',
    ...
    protected function casts(): array
    {
        return [
            ...
            'allow_provide_additional_descriptions' => 'boolean',
            'allow_gst_invoice' => 'boolean',
            'allow_alternate_units' => 'boolean',
            'allow_customer_based_pricing' => 'boolean',
