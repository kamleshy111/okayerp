    ...
    public function store(Request $request){
        ...
        try {
            ...
            $purchase = Purchase::create([
                ...
                'transport_amount' => $request->filled('transport') ? (float)$request->input('transport') : 0.00,
                'grand_total' => $request->filled('grand_total') ? (float)$request->input('grand_total') : 0.00,
                'total_amount' => $request->filled('total_amount') ? (float)$request->input('total_amount') : 0.00,
                'gst_amount' => $request->filled('GstAmount') ? (float)$request->input('GstAmount') : 0.00,
                'accepted' => $request->input('accepted') ?? 0,
                'paid'  => $request->filled('paid') ? (float)$request->input('paid') : 0.00,
